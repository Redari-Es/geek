...
#获取问题列表
title_link = driver.find_element_by_class_name('title-link')
for i in title_link:
    #打开问题详细页并切换窗口
    ...
    try:
        ...
        #获取答案列表
        answer_list = driver.find_element_by_class_name('dt,mb-4,line')
        for k in answer_list:
            ...
            if text:
                ...
                driver.find_element_by_xpath(
                    '//*[@id="answer-editor"]/div[2]/a').click()
                time.sleep(5)
                #关闭问题详细页的窗口
                driver.switch_to_window(driver.window_handles[1])
                driver.close()
